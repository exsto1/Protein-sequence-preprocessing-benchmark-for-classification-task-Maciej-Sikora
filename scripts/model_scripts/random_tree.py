...
def random_tree_func(datafile="../../data/clean_dataset_triplets.pkl"):
    ...
    model_combined = GridSearchCV(RandomForestClassifier(), param_grid=params, scoring="accuracy", cv=2, n_jobs=2, verbose=3)
    try:
